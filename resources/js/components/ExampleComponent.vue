...
<html lang="en">
   ...
   <head>
      ...
      <link rel="stylesheet/scss" type="text/css" href="css/style.scss" />
   </head>
   <body>
      ...
      <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
         <a class="navbar-brand me-lg-5" href="https://demo.themesberg.com/volt-pro/index.html"><img class="navbar-brand-dark" src="https://demo.themesberg.com/volt-pro/assets/img/brand/light.svg" alt="Volt logo"> <img class="navbar-brand-light" src="https://demo.themesberg.com/volt-pro/assets/img/brand/dark.svg" alt="Volt logo"></a>
                           ...
                           <div class="list-group list-group-flush">
                              ...
                              <a href="../calendar.html" class="list-group-item list-group-item-action border-bottom">
                                 <div class="row align-items-center">
                                    <div class="col-auto"> <img alt="Image placeholder" src="assets/img/team/profile-picture-1.jpg" class="avatar-md rounded"></div>
